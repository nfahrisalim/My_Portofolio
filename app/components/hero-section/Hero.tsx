    ...
    >
      <div className="text sm:w-[60%]">
        ...
        >
          ...
          <span className="bg-gradient-to-br bg-clip-text text-transparent from-[#66bb6a] via-[#3b9d61] to-[#1e7d43]">
            Naufal
          </span>
        ...
        >
          currently focused on expanding my own ability.
        </motion.p>
      </div>

      {/* IMAGE */}
      <div data-blobity-tooltip="Dissent">
        <motion.div
          ref={imgRef}
          style={{ rotate }}
        ...
        >
          <Image
            src="/transparent-dissent.png"
            priority
            fill
            alt="Dissent's picture"
